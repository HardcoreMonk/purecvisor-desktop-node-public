# Installed operator surface current-card 2026-05-18 0.42.31

evidence_id: `installed-operator-surface-current-card-2026-05-18-04231`
result: `PASS`
scope: `installed-web-tui-cli-current-card`
adr: `ADR-0006`
distribution_scope: `internal-private-network-only`
artifact_root: `artifacts/installed-operator-surface-current-card-20260518-04231`
summary: `artifacts/installed-operator-surface-current-card-20260518-04231/summary.json`
version: `0.42.31-admin-smoke`
package_build_evidence: `docs/ga-ready/evidence/admin-smoke-package-2026-05-18-04231.md`
manual_admin_campaign_evidence: `docs/ga-ready/evidence/manual-admin-campaign-2026-05-18-04230-04231.md`
package_artifact_root: `artifacts/routeparity-service-msi-hyperv-batch-profile-20260518-04231`
manifest_version: `0.42.31-admin-smoke`
service_state: `Running`
msi_sha256: `c03fab45ffec262ead1d4c41cb650a2c9b52c1030a5d7cbf461bd7c78a46499f`
...
batch_evidence_batch_id: `full-admin-host-mutation-gate-20260518-04231`
current_manual_admin_package_pair: `0.42.30-admin-smoke -> 0.42.31-admin-smoke`
current_manual_admin_descriptor_batch_id: `manual-admin-campaign-descriptor-20260518-04230-04231-closed`
...
이 evidence는 `0.42.31-admin-smoke` full admin host mutation gate와
`0.42.30-admin-smoke -> 0.42.31-admin-smoke` manual-admin package-pair closure 이후,
...
| batch evidence | `available`, latest batch `full-admin-host-mutation-gate-20260518-04231` |
| manual-admin current pair | `0.42.30-admin-smoke -> 0.42.31-admin-smoke` |
| descriptor closure | `manual-admin-campaign-descriptor-20260518-04230-04231-closed`, `missing_count=0`, `not_pass_count=0` |
